...
namespace Easyagency\LaravelAdmin;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\Facades\File;
use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use Easyagency\LaravelAdmin\Console\ControllerMakeCommand;
use Easyagency\LaravelAdmin\Console\RequestMakeCommand;
...
class LaravelAdminServiceProvider extends ServiceProvider
{
    ...
    {
        return [
            'namespace' => 'Easyagency\LaravelAdmin\Http\Controllers',
    ...
    protected function registerBreadcrumbs()
    {
        ...
        config()->set('breadcrumbs.manager-class', \Easyagency\LaravelAdmin\Breadcrumbs\BreadcrumbsManager::class);
    }
